  ...
  return (
    ...
    >
      ...
      <ul className="flex flex-col items-center lg:flex-row gap-2.5 lg:gap-5 flex-1 justify-center md:justify-start">
        <li>
          <Link className="font-medium hover:text-blue-700 transition-colors duration-300">Catalogue</Link>
        </li>
        <li>
      ...
      <div className="flex gap-2.5 flex-wrap mt-2 md:mt-0">
        {auth.user ? (
          <button className="py-2 px-4 rounded-lg border border-gray-400 bg-white text-black hover:bg-blue-700 hover:text-white transition-all duration-300">
            Se Déconnecter
          </button>
        ) : (
          <>
